...
The configurator shows previews generated by Fuzzyficator's actual texture engine. Choose a texture and a labelled physical feature size, adjust height and speed, then copy the complete Bambu Studio / OrcaSlicer post-processing command. Random has one preview because it has no coherent spatial feature size.
